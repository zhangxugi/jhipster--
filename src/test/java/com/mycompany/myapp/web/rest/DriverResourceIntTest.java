...
import com.mycompany.myapp.JhipsetrsApp;
...
@SpringBootTest(classes = JhipsetrsApp.class)
public class DriverResourceIntTest {
    ...
    private static final String DEFAULT_DSEX = "AAAAAAAAAA";
    private static final String UPDATED_DSEX = "BBBBBBBBBB";
    ...
    public void createDriver() throws Exception {
        ...
        assertThat(testDriver.getDname()).isEqualTo(DEFAULT_DNAME);
        assertThat(testDriver.getDsex()).isEqualTo(DEFAULT_DSEX);
    }
    ...
    public void getAllDrivers() throws Exception {
        ...
        restDriverMockMvc.perform(get("/api/drivers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dsex").value(hasItem(DEFAULT_DSEX.toString())));
    }
    ...
    public void getDriver() throws Exception {
        ...
        restDriverMockMvc.perform(get("/api/drivers/{id}", driver.getId()))
            ...
            .andExpect(jsonPath("$.dsex").value(DEFAULT_DSEX.toString()));
    }
    ...
    public void updateDriver() throws Exception {
        ...
        Driver testDriver = driverList.get(driverList.size() - 1);
        assertThat(testDriver.getDname()).isEqualTo(UPDATED_DNAME);
        assertThat(testDriver.getDsex()).isEqualTo(UPDATED_DSEX);
    }
